...
const CATALOGO = [
  ...
  { id: 'vela-casa',      nome: 'Casa de Cera',   categoria: 'velas', energia: 'Proteção do lar', preco: 20.00, validade: '36 meses', sku: 'VEL-CASA-001', badge: null, img: 'https://images.pexels.com/photos/2082105/pexels-photo-2082105.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=400', desc: 'Representação oca de casa em cera branca ou amarelada, sem pavio. Geralmente representa um pedido por proteção de um lar, compra de casa própria ou gratidão por uma graça alcançada relacionada à moradia.' },
  ...
  // ==========================================================
  { id: 'hibisco',        nome: 'Hibisco',        categoria: 'ervas', energia: 'Amor-próprio', preco: 5.00, validade: '12 meses', sku: 'ERV-HIB-001', badge: '💕 Nova', img: 'https://images.pexels.com/photos/4625730/pexels-photo-4625730.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=400', desc: 'Ligado a amor-próprio, sensualidade, autoestima e vitalidade. Muito usado em banhos para abrir caminhos afetivos e elevar energia pessoal. Também associado à energia feminina e prosperidade emocional. Fitoterapia: Diurético, ajuda retenção de líquidos, pressão arterial e colesterol. Rico em antioxidantes.' },
  { id: 'jurema',         nome: 'Jurema Preta',   categoria: 'ervas', energia: 'Força ancestral', preco: 12.00, validade: '14 meses', sku: 'ERV-JUR-001', badge: '🌟 Especial', img: 'https://images.pexels.com/photos/162380/pexels-photo-162380.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=400', desc: 'Uma das ervas mais sagradas em tradições indígenas e afro-brasileiras. Associada à expansão espiritual, proteção e conexão ancestral. Muito ligada à "força da mata" e trabalhos de firmeza espiritual. Fitoterapia: Cicatrização e inflamações. Algumas espécies possuem propriedades antimicrobianas.' },
  ...
  // ==========================================================
  { id: 'defumador-5',    nome: 'Defumador',      categoria: 'defumacao', energia: 'Conforme indicação', preco: 5.00, validade: '24 meses', sku: 'DEF-GEN-001', badge: null, img: 'https://images.pexels.com/photos/1520374/pexels-photo-1520374.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=400', desc: 'Cada defumador serve para aquilo que é indicado na frente da caixa. Defumações com ervas selecionadas para diferentes necessidades espirituais.' },
];
