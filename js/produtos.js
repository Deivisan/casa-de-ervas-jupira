...
const CATALOGO = [
  ...
  // ==========================================================
  { id: 'hibisco',        nome: 'Hibisco',        categoria: 'ervas', energia: 'Amor-próprio', preco: 5.00, validade: '12 meses', sku: 'ERV-HIB-001', badge: '💕 Nova', img: '', desc: 'Ligado a amor-próprio, sensualidade, autoestima e vitalidade. Muito usado em banhos para abrir caminhos afetivos e elevar energia pessoal. Também associado à energia feminina e prosperidade emocional. Fitoterapia: Diurético, ajuda retenção de líquidos, pressão arterial e colesterol. Rico em antioxidantes.' },
  { id: 'jurema',         nome: 'Jurema Preta',   categoria: 'ervas', energia: 'Força ancestral', preco: 12.00, validade: '14 meses', sku: 'ERV-JUR-001', badge: '🌟 Especial', img: '', desc: 'Uma das ervas mais sagradas em tradições indígenas e afro-brasileiras. Associada à expansão espiritual, proteção e conexão ancestral. Muito ligada à "força da mata" e trabalhos de firmeza espiritual. Fitoterapia: Cicatrização e inflamações. Algumas espécies possuem propriedades antimicrobianas.' },
  { id: 'erva-cidreira',  nome: 'Erva Cidreira',  categoria: 'ervas', energia: 'Tranquilidade', preco: 6.00, validade: '10 meses', sku: 'ERV-CID-001', badge: null, img: '', desc: 'Traz calma, equilíbrio emocional e paz no ambiente. Banhos e chás para aliviar tristeza, ansiedade e energia pesada. Fitoterapia: Calmante natural. Ajuda em ansiedade leve, insônia e desconforto digestivo. Pode aliviar cólicas e tensão nervosa.' },
  { id: 'arruda',         nome: 'Arruda',         categoria: 'ervas', energia: 'Proteção', preco: 8.00, validade: '12 meses', sku: 'ERV-ARR-001', badge: '🔥 Mais vendida', img: '', desc: 'Uma das ervas mais usadas contra inveja, mau-olhado e energia negativa. Muito usada em banhos de descarrego e proteção espiritual. Tradicionalmente colocada atrás da orelha ou na entrada da casa. Fitoterapia: Cólicas, circulação, ação estimulante e anti-inflamatória.' },
  { id: 'unha-de-gato',   nome: 'Unha de Gato',   categoria: 'ervas', energia: 'Força e resistência', preco: 10.00, validade: '12 meses', sku: 'ERV-UNG-001', badge: null, img: '', desc: 'Associada à força, resistência espiritual e proteção energética. Usada para fortalecimento interno e limpeza de cargas emocionais. Fitoterapia: Anti-inflamatória. Muito usada para imunidade e dores articulares. Popular em tratamentos complementares.' },
  { id: 'bardana',        nome: 'Bardana',        categoria: 'ervas', energia: 'Purificação', preco: 9.00, validade: '14 meses', sku: 'ERV-BAR-001', badge: null, img: '', desc: 'Relacionada à purificação e limpeza profunda. Associada à retirada de energias densas acumuladas. Fitoterapia: Pele, fígado e desintoxicação. Pode auxiliar em acne e inflamações cutâneas.' },
  { id: 'camomila',       nome: 'Camomila',       categoria: 'ervas', energia: 'Calma', preco: 7.00, validade: '12 meses', sku: 'ERV-CAM-001', badge: null, img: '', desc: 'Atrai serenidade, harmonia e acolhimento. Muito usada em banhos para acalmar conflitos emocionais e familiares. Fitoterapia: Calmante suave. Ajuda no sono, ansiedade leve e digestão. Também usada para irritações leves da pele.' },
  { id: 'erva-doce',      nome: 'Erva Doce',      categoria: 'ervas', energia: 'Harmonia', preco: 6.00, validade: '12 meses', sku: 'ERV-DOC-001', badge: null, img: '', desc: 'Associada à doçura, prosperidade e equilíbrio emocional. Usada para harmonizar relações e trazer leveza. Fitoterapia: Gases, cólicas e digestão. Calmante leve, especialmente em crianças.' },
  { id: 'eucalipto',      nome: 'Eucalipto',      categoria: 'ervas', energia: 'Limpeza energética', preco: 7.00, validade: '12 meses', sku: 'ERV-EUC-001', badge: null, img: '', desc: 'Forte erva de limpeza energética. Usado em defumações para descarrego e renovação do ambiente. Fitoterapia: Conhecido para vias respiratórias. Ajuda em congestão nasal, tosse e inalações.' },
  { id: 'salvia',         nome: 'Sálvia',         categoria: 'ervas', energia: 'Purificação', preco: 9.00, validade: '14 meses', sku: 'ERV-SAL-001', badge: null, img: '', desc: 'Uma das ervas mais tradicionais para purificação energética. Defumações com sálvia são usadas para limpar ambientes e pensamentos negativos. Fitoterapia: Inflamações da garganta, digestão e suor excessivo. Propriedades antioxidantes e antimicrobianas.' },
  { id: 'hortela',        nome: 'Hortelã',        categoria: 'ervas', energia: 'Prosperidade', preco: 6.00, validade: '10 meses', sku: 'ERV-HOR-001', badge: null, img: '', desc: 'Relacionada à prosperidade, movimento e renovação. Muito usada para elevar a vibração e estimular energia positiva. Fitoterapia: Digestão, enjoo e gases. Refrescante para vias respiratórias e dores leves.' },
  { id: 'aroeira',        nome: 'Aroeira',        categoria: 'ervas', energia: 'Cura física', preco: 8.00, validade: '14 meses', sku: 'ERV-ARO-001', badge: null, img: '', desc: 'Associada à força espiritual, proteção e quebra de negatividade. Bastante usada em banhos de descarrego e fortalecimento. Fitoterapia: Inflamações, cicatrização e saúde íntima feminina. Propriedades antimicrobianas.' },
